  ...
  return (
    <div className="w-[150px] hidden justify-between lg:flex">
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger>
          <div className="py-3 px-4 font-[700] rounded-full text-white cursor-pointer">
            Login
          </div>
        </DialogTrigger>
        ...
        <DialogContent>
          {googleMutation.isPending ? (
            ...
            <>
              ...
              <form
                onSubmit={handleSubmit(guestLogin)}
                className="space-y-2 pb-10 px-5"
              >
                <input
                  {...register("email")}
                  type="email"
...
function SingupModal() {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <div className="py-3 px-4 font-[700] text-white cursor-pointer">
          Signup
        </div>
      </DialogTrigger>
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmitSignup(guestSignup)} className="px-5">
          <input
            {...registerSigup("email")}
            placeholder="Email"
            className="w-full py-3 px-2 border-b"
